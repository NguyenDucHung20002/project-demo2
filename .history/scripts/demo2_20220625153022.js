...
window.addEventListener("load", function () {
  ...
  const widthSliderItem = imgItem[0].offset;
  console.log("widthSliderItem:", widthSliderItem);
  const sliderLeng = imgItem.length;
  console.log("sliderLeng:", sliderLeng);
  wrapImg.style.width = `${widthSliderItem * sliderLeng}px`;
});
