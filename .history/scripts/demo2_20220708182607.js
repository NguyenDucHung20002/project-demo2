...
$(document).ready(function () {
  ...
  window.addEventListener("resize", function (e) {
    ...
    if (winwidth >= 992 && boolethre === true) {
      $(".header-btm-mobile")
        .css("visibility", "visible")
        .css("opacity", "1")
        .find(".container")
        ...
        .css("transform", "translateY(0)");
      boolethre = false;
    } else if (winwidth < 992 && boolethre === false) {
      $(".header-btm-mobile").trigger("click");
      boolethre = true;
      boole = false;
      booletwo = false;
            ...
            <div class="detail-product row">
                ...
                <div class="detailed-product-content col-md-6 col-xs-sm-12">
                    ...
                    <div class="product-size">
                        <p>size:</p>
                        <a href="" class="size medium">M</a>
                        <a href="" class="size lager">L</a>
                    </div>
...
$(".product-action-view").click(function (e) {
  ...
  let position = 0;
  let index = 0;
  const hightSliderItem = $(".slider-img img").height();
  const wSliderItem = $(".slider-img img").width();
  console.log("wSliderItem:", wSliderItem);
