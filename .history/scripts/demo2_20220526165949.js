...
document.addEventListener("click", function (e) {
  ...
  if (btnPlus) {
    console.log(btnPlus.data("id"));
    const indxCart = cart.findIndex((val) => val.id == btnPlus.setdata.id);
    // if (cart[indxCart].quantity >= 1) {
...
$(document).ready(function () {
  ...
  $(".quantity-minus").click(function (e) {
    ...
    const indxCart = cart.findIndex((val) => val.id == index);
