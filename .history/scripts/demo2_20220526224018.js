...
document.addEventListener("click", function (e) {
  ...
  if (inputControl) {
    console.log("old ", inputControl.value);
  }
  if (btnPlus) {
...
function getquantity() {
  ...
  console.log("total", quantity.value, getparent);
  cart.forEach((val) => {
    if (val.id == getid) {
      subtotal -= val.price * oldquantity;
      subtotal += val.price * quantity.value;
    }
  });
  renderCart();
}
$(document).ready(function () {
  ...
  //   const quantityInput = document.querySelector(".quantity-control");
  //   document.addEventListener("click", function (a) {
  //     const quantityInputNull = a.target.closest(".quantity-control");
  //     if (!quantityInputNull) {
...
function renderCart() {
  ...
  <div class="product-cart">
    ...
    <div class="content">
        ...
        <div class="quantity-and-price">
           <div class="input-group-quantity">
               ...
               <input class="quantity-control" data-id="${val.id}" id="fname" onchange="getquantity()" value="${val.quantity}" type="number" min="1" max="1000">
    ...
    <div class="cart-action">
        <div data-id="${val.id}" class="check-total">
            <input id="check-total" checked type="checkbox">
            <label class="for-check-total" for="check-total"></label>
        </div>
