...
function rederScroll() {
  ...
  let productsMenuFeatured = document.querySelectorAll(
    ".product-menu-sec .products-row-main-sec"
  );
  productsMenuFeatured = productsMenuFeatured[0];
  console.log(productsMenuFeatured);
  ...
  $.each(productsMenuFeatured, function (index, val) {
    if (top + windowHeight >= $(val).offset().top) {
      $(".products-row-main")
        .eq(index)
        .find(".left")
