...
$(document).ready(function () {
  ...
  let winsta = $(".instagram-info img").width();
  $(".instagram-info .block").css({
    height: `${winsta}px`,
    width: `${winsta}px`,
  });
  $(window).resize(function () {
    winsta = $(".instagram-info img").width();
    $(".instagram-info .block").css({
      height: `${winsta}px`,
      width: `${winsta}px`,
    });
...
<div class="detail-product">
    ...
    <div class="detailed-product-content">
        ...
        <div class="rating-content">
            <div class="rating-star">
                <div class="hover-stars">4.00</div>
...
function checkDir(index, length, btnPrev, btnnext) {
  if (index === 0) {
    btnPrev.style.coler = "#666666";
  } else if (index === length - 1) {
    btnPrev.style.coler = "#222222";
  }
}
window.addEventListener("load", function () {
  ...
  btnPrev.addEventListener("click", function (e) {
    if (index > 0) {
      ...
      const prev = document.querySelector(".prev-dir");
      if (index === 0 && index < sliderLeng - 2) {
        prev.children.style.color = "#999999";
      } else {
        prev.children.style.color = "#222222";
      }
    }
  });
  btnnext.addEventListener("click", function (e) {
    if (index < sliderLeng - 1) {
      ...
      position -= widthSliderItem;
      wrapImg.style = `transform: translateX(${position}px)`;
      const next = document.querySelector(".next-dir");
      if (index > 0 && index === sliderLeng - 1) {
        next.childNodes.style.color = "#999999";
      } else {
        next.childNodes.style.color = "#222222";
      }
    }
  });
});
